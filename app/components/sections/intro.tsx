    ...
    <section>
      <div className="flex flex-row gap-6">
        ...
        <div className="flex flex-col justify-evenly">
          ...
          <p className="text-lg">Interim CTO at <a href="https://www.treeprotocol.xyz/" target="_blank">TREE Protocol</a> creating <a href="https://hadea.ec.europa.eu/calls-proposals/digital-product-passport_en" title="Digital Product Passport" target="_blank">DPPs</a></p>
